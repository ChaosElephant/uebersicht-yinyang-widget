...
#yinyang #yin > div,
#yinyang #yang > div {
  -webkit-animation: yy-rotateZ 12s steps(360) infinite;
          animation: yy-rotateZ 12s steps(360) infinite; }
