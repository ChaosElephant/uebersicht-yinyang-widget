...
update: (e, domEl) ->
  ...
  $(domEl).find('#yinyang-lavalamp-widget').append('<script>!function(){"use strict";function s(r,i){var l=u(11,21);r&&u(0,128)<=1?(clearTimeout(c.light),clearTimeout(c.dark),m[1].style="--td:6s;--bg-color:rgba(254,221,0,9.5);",m[0].style="--td:6s;--bg-color:rgba(0,87,184,9.5);",setTimeout(function(){s()},1e3*l)):["light","dark"].forEach(function(t,e){var n,o,a;(!r||i&&t==i)&&(clearTimeout(c[t]),m[e].style="--td:"+l+"s;--bg-color:"+(n="light"==(n=t),o=[0,360],a=u(0,17)<=3?[0,10]:n?[10,70]:[20,96],n=n?[60,100]:[10,40],"hsla("+[u(o[0],o[1]),u(a[0],a[1])+"%",u(n[0],n[1])+"%"].join()+","+u(73,81)/100+")"),c[t]=setTimeout(function(){s(r,t)},1e3*l),1==e&&(r=!0))})}var t=["yinyang","y-holder","x-holder","z-holder","z-m"],c={},m=[document.getElementsByClassName("yy--yin")[0],document.getElementsByClassName("yy--yang")[0]],u=function(t,e){return Math.floor(Math.random()*(e-t+1))+t},o=function(t){for(var e,n,o=t.length;0!==o;)n=Math.floor(Math.random()*o),e=t[--o],t[o]=t[n],t[n]=e;return t}([...Array(t.length).keys()]);t.forEach(function(t,e){var n;t=t,e=4*(o[e=e]+1),t=document.getElementsByClassName(t)[0].style,n=u(0,.75*(e=48+e)),t.animationDelay=-1*n+"s",t.animationDuration=e+"s",1<=u(0,1)&&(t.animationDirection="reverse")}),s()}();</script>');