...
#yinyang-output {
  ...
  #yinyang-output #yinyang {
    ...
    #yinyang-output #yinyang > div#yang {
      opacity: 0.93; }
    #yinyang-output #yinyang > div#yin {
      -webkit-animation: yy-yinY 55s cubic-bezier(0.6, 0, 0, 1) infinite;
              animation: yy-yinY 55s cubic-bezier(0.6, 0, 0, 1) infinite; }
    #yinyang-output #yinyang > div#yang {
      -webkit-animation: yy-yangY 55s cubic-bezier(0.6, 0, 0, 1) infinite;
              animation: yy-yangY 55s cubic-bezier(0.6, 0, 0, 1) infinite; }
  #yinyang-output.b {
...
#yinyang #yin > div,
#yinyang #yang > div {
  -webkit-animation: yy-rotateZ 8s steps(360) infinite;
          animation: yy-rotateZ 8s steps(360) infinite; }
